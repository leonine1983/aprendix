...
urlpatterns = [
    path('', include('gestao_escolar.urls.prefeitura')),
    ...
    path('', include('gestao_escolar.urls.migracao_exportacao')),   
    path('novas_matriculas/', include('gestao_escolar.urls.matricula_online')),   
    ...
    path("faltas/<int:matricula>/<int:grade>/<int:trimestre>/<str:falta>/", faltas_usa_dialog, name="faltas_usa_dialog" ),
