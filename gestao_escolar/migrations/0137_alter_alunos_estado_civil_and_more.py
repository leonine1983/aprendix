...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0136_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('3', 'B+'), ('2', 'A-'), ('7', 'O+'), ('0', 'Não informado'), ('6', 'AB-'), ('8', 'O-'), ('5', 'AB+'), ('4', 'B-')], max_length=3, null=True),
        ),
        migrations.AlterField(
