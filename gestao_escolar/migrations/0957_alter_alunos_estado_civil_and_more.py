...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0956_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('2', 'Casado'), ('6', 'União Estável'), ('1', 'Solteiro'), ('3', 'Separado'), ('4', 'Divorciado'), ('5', 'Viúvo')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('2', 'A-'), ('7', 'O+'), ('4', 'B-'), ('8', 'O-'), ('1', 'A+'), ('3', 'B+'), ('6', 'AB-'), ('0', 'Não informado'), ('5', 'AB+')], max_length=3, null=True),
        ),
        migrations.AlterField(
