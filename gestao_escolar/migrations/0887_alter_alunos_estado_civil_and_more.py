...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0886_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('7', 'O+'), ('4', 'B-'), ('8', 'O-'), ('3', 'B+'), ('6', 'AB-'), ('5', 'AB+'), ('0', 'Não informado'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
