...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '1047_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('8', 'O-'), ('1', 'A+'), ('0', 'Não informado'), ('4', 'B-'), ('5', 'AB+'), ('3', 'B+'), ('2', 'A-'), ('7', 'O+'), ('6', 'AB-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
