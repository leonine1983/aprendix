...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0952_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('4', 'Divorciado'), ('6', 'União Estável'), ('1', 'Solteiro'), ('5', 'Viúvo'), ('2', 'Casado'), ('3', 'Separado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('2', 'A-'), ('1', 'A+'), ('3', 'B+'), ('6', 'AB-'), ('5', 'AB+'), ('7', 'O+'), ('0', 'Não informado'), ('4', 'B-'), ('8', 'O-')], max_length=3, null=True),
        ),
        migrations.AlterField(
