...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0892_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('3', 'Separado'), ('1', 'Solteiro'), ('5', 'Viúvo'), ('2', 'Casado'), ('6', 'União Estável'), ('4', 'Divorciado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tipo_certidao',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('6', 'AB-'), ('7', 'O+'), ('4', 'B-'), ('0', 'Não informado'), ('2', 'A-'), ('8', 'O-'), ('3', 'B+'), ('5', 'AB+')], max_length=3, null=True),
        ),
        migrations.AlterField(
