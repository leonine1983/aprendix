...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0511_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('6', 'União Estável'), ('1', 'Solteiro'), ('2', 'Casado'), ('3', 'Separado'), ('5', 'Viúvo'), ('4', 'Divorciado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('5', 'AB+'), ('1', 'A+'), ('7', 'O+'), ('6', 'AB-'), ('8', 'O-'), ('4', 'B-'), ('2', 'A-'), ('3', 'B+')], max_length=3, null=True),
        ),
        migrations.AlterField(
