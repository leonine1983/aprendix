...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0555_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('2', 'A-'), ('4', 'B-'), ('3', 'B+'), ('0', 'Não informado'), ('5', 'AB+'), ('1', 'A+'), ('7', 'O+'), ('8', 'O-'), ('6', 'AB-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
