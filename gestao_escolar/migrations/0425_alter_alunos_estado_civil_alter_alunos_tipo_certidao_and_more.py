...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0424_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('3', 'Separado'), ('2', 'Casado'), ('5', 'Viúvo'), ('1', 'Solteiro'), ('4', 'Divorciado'), ('6', 'União Estável')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tipo_certidao',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('7', 'O+'), ('8', 'O-'), ('0', 'Não informado'), ('2', 'A-'), ('4', 'B-'), ('6', 'AB-'), ('1', 'A+'), ('3', 'B+'), ('5', 'AB+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
