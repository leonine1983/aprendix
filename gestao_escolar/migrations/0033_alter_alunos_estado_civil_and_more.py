...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0032_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('5', 'AB+'), ('2', 'A-'), ('7', 'O+'), ('4', 'B-'), ('6', 'AB-'), ('3', 'B+'), ('0', 'Não informado'), ('8', 'O-')], max_length=3, null=True),
        ),
        migrations.AlterField(
