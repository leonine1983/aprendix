...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0935_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('3', 'B+'), ('7', 'O+'), ('2', 'A-'), ('6', 'AB-'), ('5', 'AB+'), ('8', 'O-'), ('0', 'Não informado'), ('1', 'A+')], max_length=3, null=True),
        ),
        migrations.AlterField(
