...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0211_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('8', 'O-'), ('6', 'AB-'), ('5', 'AB+'), ('7', 'O+'), ('3', 'B+'), ('0', 'Não informado'), ('1', 'A+'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
