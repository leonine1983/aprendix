...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0983_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('5', 'AB+'), ('3', 'B+'), ('1', 'A+'), ('0', 'Não informado'), ('2', 'A-'), ('4', 'B-'), ('8', 'O-'), ('6', 'AB-'), ('7', 'O+')], max_length=3, null=True),
        ),
        migrations.AlterField(
