...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0252_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('6', 'AB-'), ('7', 'O+'), ('0', 'Não informado'), ('4', 'B-'), ('1', 'A+'), ('3', 'B+'), ('5', 'AB+'), ('2', 'A-'), ('8', 'O-')], max_length=3, null=True),
        ),
        migrations.AlterField(
