...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0802_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('3', 'B+'), ('4', 'B-'), ('0', 'Não informado'), ('7', 'O+'), ('8', 'O-'), ('6', 'AB-'), ('1', 'A+'), ('5', 'AB+'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
