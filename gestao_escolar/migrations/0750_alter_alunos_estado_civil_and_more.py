...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0749_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('8', 'O-'), ('5', 'AB+'), ('3', 'B+'), ('2', 'A-'), ('4', 'B-'), ('6', 'AB-'), ('7', 'O+'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
