...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0181_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('7', 'O+'), ('2', 'A-'), ('6', 'AB-'), ('8', 'O-'), ('1', 'A+'), ('0', 'Não informado'), ('5', 'AB+'), ('4', 'B-'), ('3', 'B+')], max_length=3, null=True),
        ),
        migrations.AlterField(
