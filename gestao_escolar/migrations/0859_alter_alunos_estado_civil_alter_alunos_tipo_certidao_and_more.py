...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0858_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('2', 'A-'), ('6', 'AB-'), ('8', 'O-'), ('4', 'B-'), ('7', 'O+'), ('5', 'AB+'), ('3', 'B+'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
