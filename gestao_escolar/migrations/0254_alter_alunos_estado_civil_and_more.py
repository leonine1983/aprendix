...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0253_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('8', 'O-'), ('4', 'B-'), ('0', 'Não informado'), ('2', 'A-'), ('7', 'O+'), ('6', 'AB-'), ('1', 'A+'), ('3', 'B+'), ('5', 'AB+')], max_length=3, null=True),
        ),
        migrations.AlterField(
