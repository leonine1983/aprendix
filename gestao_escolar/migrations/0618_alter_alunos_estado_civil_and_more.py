...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0617_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('3', 'B+'), ('1', 'A+'), ('4', 'B-'), ('2', 'A-'), ('7', 'O+'), ('8', 'O-'), ('5', 'AB+'), ('6', 'AB-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
