...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0137_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('6', 'União Estável'), ('1', 'Solteiro'), ('2', 'Casado'), ('5', 'Viúvo'), ('4', 'Divorciado'), ('3', 'Separado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('3', 'B+'), ('7', 'O+'), ('0', 'Não informado'), ('4', 'B-'), ('5', 'AB+'), ('8', 'O-'), ('1', 'A+'), ('6', 'AB-'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
