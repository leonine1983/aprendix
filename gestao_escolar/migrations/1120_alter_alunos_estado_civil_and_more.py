...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '1119_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('6', 'União Estável'), ('1', 'Solteiro'), ('5', 'Viúvo'), ('4', 'Divorciado'), ('2', 'Casado'), ('3', 'Separado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('8', 'O-'), ('1', 'A+'), ('5', 'AB+'), ('4', 'B-'), ('6', 'AB-'), ('7', 'O+'), ('3', 'B+'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
