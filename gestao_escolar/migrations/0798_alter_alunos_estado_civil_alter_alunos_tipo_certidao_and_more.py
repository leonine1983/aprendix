...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0797_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('7', 'O+'), ('6', 'AB-'), ('2', 'A-'), ('8', 'O-'), ('5', 'AB+'), ('3', 'B+'), ('0', 'Não informado'), ('1', 'A+'), ('4', 'B-')], max_length=3, null=True),
        ),
        migrations.AlterField(
