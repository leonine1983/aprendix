...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0251_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('3', 'B+'), ('2', 'A-'), ('8', 'O-'), ('5', 'AB+'), ('6', 'AB-'), ('4', 'B-'), ('0', 'Não informado'), ('7', 'O+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
