# Generated by Django 5.0.4 on 2024-07-30 14:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0877_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('8', 'O-'), ('5', 'AB+'), ('2', 'A-'), ('3', 'B+'), ('1', 'A+'), ('4', 'B-'), ('0', 'Não informado'), ('6', 'AB-'), ('7', 'O+')], max_length=3, null=True),
        ),
        migrations.AlterField(
