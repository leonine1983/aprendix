...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0509_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('2', 'A-'), ('4', 'B-'), ('7', 'O+'), ('3', 'B+'), ('6', 'AB-'), ('8', 'O-'), ('0', 'Não informado'), ('5', 'AB+'), ('1', 'A+')], max_length=3, null=True),
        ),
        migrations.AlterField(
