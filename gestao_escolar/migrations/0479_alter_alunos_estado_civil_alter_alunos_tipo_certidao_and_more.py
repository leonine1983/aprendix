...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0478_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('4', 'Divorciado'), ('5', 'Viúvo'), ('6', 'União Estável'), ('1', 'Solteiro'), ('3', 'Separado'), ('2', 'Casado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tipo_certidao',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('5', 'AB+'), ('2', 'A-'), ('3', 'B+'), ('1', 'A+'), ('0', 'Não informado'), ('8', 'O-'), ('6', 'AB-'), ('4', 'B-'), ('7', 'O+')], max_length=3, null=True),
        ),
        migrations.AlterField(
