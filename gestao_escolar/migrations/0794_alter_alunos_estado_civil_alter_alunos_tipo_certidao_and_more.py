...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0793_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('3', 'B+'), ('8', 'O-'), ('2', 'A-'), ('7', 'O+'), ('4', 'B-'), ('6', 'AB-'), ('5', 'AB+'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
