...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '1037_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('1', 'Solteiro'), ('6', 'União Estável'), ('2', 'Casado'), ('5', 'Viúvo'), ('4', 'Divorciado'), ('3', 'Separado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('3', 'B+'), ('6', 'AB-'), ('0', 'Não informado'), ('5', 'AB+'), ('7', 'O+'), ('1', 'A+'), ('2', 'A-'), ('8', 'O-'), ('4', 'B-')], max_length=3, null=True),
        ),
        migrations.AlterField(
