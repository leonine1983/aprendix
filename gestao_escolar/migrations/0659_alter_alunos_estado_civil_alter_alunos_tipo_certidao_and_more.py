...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0658_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('2', 'A-'), ('6', 'AB-'), ('3', 'B+'), ('4', 'B-'), ('7', 'O+'), ('8', 'O-'), ('1', 'A+'), ('5', 'AB+'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
