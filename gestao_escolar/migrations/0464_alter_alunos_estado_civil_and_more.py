...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0463_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('4', 'B-'), ('7', 'O+'), ('5', 'AB+'), ('1', 'A+'), ('8', 'O-'), ('6', 'AB-'), ('3', 'B+'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
