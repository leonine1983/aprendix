...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0480_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('6', 'AB-'), ('4', 'B-'), ('8', 'O-'), ('5', 'AB+'), ('3', 'B+'), ('2', 'A-'), ('7', 'O+'), ('0', 'Não informado'), ('1', 'A+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
