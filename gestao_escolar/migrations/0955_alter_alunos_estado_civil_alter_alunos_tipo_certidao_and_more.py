...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0954_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('0', 'Não informado'), ('6', 'AB-'), ('5', 'AB+'), ('8', 'O-'), ('4', 'B-'), ('7', 'O+'), ('3', 'B+'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
