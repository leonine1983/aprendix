...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0379_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('5', 'AB+'), ('6', 'AB-'), ('4', 'B-'), ('2', 'A-'), ('7', 'O+'), ('8', 'O-'), ('1', 'A+'), ('3', 'B+'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
