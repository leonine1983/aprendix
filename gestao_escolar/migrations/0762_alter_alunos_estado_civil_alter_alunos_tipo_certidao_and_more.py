...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0761_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('7', 'O+'), ('6', 'AB-'), ('2', 'A-'), ('3', 'B+'), ('4', 'B-'), ('1', 'A+'), ('5', 'AB+'), ('8', 'O-')], max_length=3, null=True),
        ),
        migrations.AlterField(
