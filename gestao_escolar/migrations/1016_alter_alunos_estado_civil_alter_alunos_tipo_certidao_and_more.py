...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '1015_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('5', 'AB+'), ('6', 'AB-'), ('0', 'Não informado'), ('4', 'B-'), ('8', 'O-'), ('7', 'O+'), ('3', 'B+'), ('2', 'A-'), ('1', 'A+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
