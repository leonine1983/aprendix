...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0148_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('3', 'B+'), ('5', 'AB+'), ('0', 'Não informado'), ('4', 'B-'), ('7', 'O+'), ('1', 'A+'), ('8', 'O-'), ('2', 'A-'), ('6', 'AB-')], max_length=3, null=True),
        ),
        migrations.AlterField(
