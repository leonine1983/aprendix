...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0532_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('6', 'AB-'), ('0', 'Não informado'), ('3', 'B+'), ('4', 'B-'), ('8', 'O-'), ('5', 'AB+'), ('1', 'A+'), ('7', 'O+'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
