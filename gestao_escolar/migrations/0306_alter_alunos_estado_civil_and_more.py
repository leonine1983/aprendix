...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0305_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('1', 'A+'), ('2', 'A-'), ('3', 'B+'), ('6', 'AB-'), ('7', 'O+'), ('5', 'AB+'), ('0', 'Não informado'), ('8', 'O-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
