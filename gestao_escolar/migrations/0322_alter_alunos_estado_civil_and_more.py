...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0321_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('3', 'Separado'), ('5', 'Viúvo'), ('1', 'Solteiro'), ('4', 'Divorciado'), ('2', 'Casado'), ('6', 'União Estável')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('1', 'A+'), ('5', 'AB+'), ('8', 'O-'), ('0', 'Não informado'), ('3', 'B+'), ('7', 'O+'), ('6', 'AB-'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
