...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0703_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('5', 'AB+'), ('4', 'B-'), ('0', 'Não informado'), ('8', 'O-'), ('1', 'A+'), ('6', 'AB-'), ('3', 'B+'), ('7', 'O+'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
