...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0178_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('5', 'Viúvo'), ('1', 'Solteiro'), ('2', 'Casado'), ('4', 'Divorciado'), ('6', 'União Estável'), ('3', 'Separado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('5', 'AB+'), ('0', 'Não informado'), ('1', 'A+'), ('7', 'O+'), ('3', 'B+'), ('6', 'AB-'), ('4', 'B-'), ('2', 'A-'), ('8', 'O-')], max_length=3, null=True),
        ),
        migrations.AlterField(
