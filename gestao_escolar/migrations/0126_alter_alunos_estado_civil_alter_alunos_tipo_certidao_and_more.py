...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0125_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('2', 'A-'), ('6', 'AB-'), ('1', 'A+'), ('3', 'B+'), ('8', 'O-'), ('7', 'O+'), ('5', 'AB+'), ('4', 'B-'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
