...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0984_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('7', 'O+'), ('5', 'AB+'), ('1', 'A+'), ('2', 'A-'), ('0', 'Não informado'), ('4', 'B-'), ('6', 'AB-'), ('8', 'O-'), ('3', 'B+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
