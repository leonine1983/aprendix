...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0787_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('1', 'Solteiro'), ('3', 'Separado'), ('2', 'Casado'), ('6', 'União Estável'), ('4', 'Divorciado'), ('5', 'Viúvo')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tipo_certidao',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('3', 'B+'), ('0', 'Não informado'), ('2', 'A-'), ('1', 'A+'), ('8', 'O-'), ('7', 'O+'), ('5', 'AB+'), ('6', 'AB-')], max_length=3, null=True),
        ),
        migrations.AlterField(
