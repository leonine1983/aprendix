...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0289_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('5', 'Viúvo'), ('6', 'União Estável'), ('1', 'Solteiro'), ('4', 'Divorciado'), ('3', 'Separado'), ('2', 'Casado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('7', 'O+'), ('0', 'Não informado'), ('8', 'O-'), ('2', 'A-'), ('1', 'A+'), ('5', 'AB+'), ('6', 'AB-'), ('3', 'B+')], max_length=3, null=True),
        ),
        migrations.AlterField(
