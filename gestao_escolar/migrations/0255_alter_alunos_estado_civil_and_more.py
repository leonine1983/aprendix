...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0254_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('4', 'B-'), ('2', 'A-'), ('1', 'A+'), ('5', 'AB+'), ('3', 'B+'), ('8', 'O-'), ('6', 'AB-'), ('7', 'O+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
