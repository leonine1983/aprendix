...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0907_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('5', 'AB+'), ('7', 'O+'), ('2', 'A-'), ('8', 'O-'), ('4', 'B-'), ('1', 'A+'), ('3', 'B+'), ('6', 'AB-'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
