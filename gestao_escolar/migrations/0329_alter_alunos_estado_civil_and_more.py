...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0328_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('3', 'Separado'), ('2', 'Casado'), ('4', 'Divorciado'), ('1', 'Solteiro'), ('5', 'Viúvo'), ('6', 'União Estável')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('5', 'AB+'), ('0', 'Não informado'), ('6', 'AB-'), ('8', 'O-'), ('2', 'A-'), ('3', 'B+'), ('7', 'O+'), ('1', 'A+'), ('4', 'B-')], max_length=3, null=True),
        ),
        migrations.AlterField(
