...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '1101_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('0', 'Não informado'), ('2', 'A-'), ('1', 'A+'), ('3', 'B+'), ('5', 'AB+'), ('6', 'AB-'), ('8', 'O-'), ('7', 'O+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
