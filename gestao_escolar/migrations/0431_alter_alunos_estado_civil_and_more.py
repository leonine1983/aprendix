...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0430_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('8', 'O-'), ('3', 'B+'), ('6', 'AB-'), ('2', 'A-'), ('1', 'A+'), ('7', 'O+'), ('5', 'AB+'), ('4', 'B-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
