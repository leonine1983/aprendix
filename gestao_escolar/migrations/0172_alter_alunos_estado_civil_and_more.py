...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0171_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('5', 'Viúvo'), ('4', 'Divorciado'), ('2', 'Casado'), ('6', 'União Estável'), ('1', 'Solteiro'), ('3', 'Separado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('7', 'O+'), ('8', 'O-'), ('0', 'Não informado'), ('6', 'AB-'), ('4', 'B-'), ('3', 'B+'), ('2', 'A-'), ('1', 'A+'), ('5', 'AB+')], max_length=3, null=True),
        ),
        migrations.AlterField(
