...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0772_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('4', 'B-'), ('8', 'O-'), ('6', 'AB-'), ('5', 'AB+'), ('2', 'A-'), ('7', 'O+'), ('1', 'A+'), ('3', 'B+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
