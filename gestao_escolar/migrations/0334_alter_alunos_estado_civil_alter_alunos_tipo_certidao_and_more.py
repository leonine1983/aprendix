...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0333_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('5', 'AB+'), ('7', 'O+'), ('1', 'A+'), ('4', 'B-'), ('0', 'Não informado'), ('3', 'B+'), ('6', 'AB-'), ('8', 'O-'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
