...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '1097_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('3', 'B+'), ('2', 'A-'), ('4', 'B-'), ('5', 'AB+'), ('7', 'O+'), ('8', 'O-'), ('6', 'AB-'), ('1', 'A+')], max_length=3, null=True),
        ),
        migrations.AlterField(
