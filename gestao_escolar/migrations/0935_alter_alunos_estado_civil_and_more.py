...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0934_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('5', 'AB+'), ('3', 'B+'), ('6', 'AB-'), ('1', 'A+'), ('2', 'A-'), ('0', 'Não informado'), ('4', 'B-'), ('7', 'O+'), ('8', 'O-')], max_length=3, null=True),
        ),
        migrations.AlterField(
