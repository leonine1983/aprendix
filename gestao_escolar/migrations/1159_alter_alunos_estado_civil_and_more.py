...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '1158_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('6', 'União Estável'), ('1', 'Solteiro'), ('3', 'Separado'), ('2', 'Casado'), ('4', 'Divorciado'), ('5', 'Viúvo')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('8', 'O-'), ('6', 'AB-'), ('2', 'A-'), ('7', 'O+'), ('0', 'Não informado'), ('4', 'B-'), ('5', 'AB+'), ('3', 'B+')], max_length=3, null=True),
        ),
        migrations.AlterField(
