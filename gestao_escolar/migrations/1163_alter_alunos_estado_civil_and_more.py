...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '1162_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('3', 'B+'), ('6', 'AB-'), ('7', 'O+'), ('5', 'AB+'), ('8', 'O-'), ('0', 'Não informado'), ('1', 'A+'), ('4', 'B-'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
