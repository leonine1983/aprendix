...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '1035_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('2', 'A-'), ('4', 'B-'), ('7', 'O+'), ('1', 'A+'), ('3', 'B+'), ('8', 'O-'), ('6', 'AB-'), ('0', 'Não informado'), ('5', 'AB+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
