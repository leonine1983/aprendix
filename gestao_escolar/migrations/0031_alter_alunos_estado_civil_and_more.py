...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0030_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('3', 'B+'), ('5', 'AB+'), ('6', 'AB-'), ('2', 'A-'), ('7', 'O+'), ('0', 'Não informado'), ('1', 'A+'), ('8', 'O-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
