...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '1152_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('3', 'B+'), ('6', 'AB-'), ('0', 'Não informado'), ('7', 'O+'), ('5', 'AB+'), ('2', 'A-'), ('8', 'O-'), ('1', 'A+')], max_length=3, null=True),
        ),
        migrations.AlterField(
