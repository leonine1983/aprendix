...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0469_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('5', 'AB+'), ('3', 'B+'), ('2', 'A-'), ('8', 'O-'), ('4', 'B-'), ('7', 'O+'), ('6', 'AB-'), ('0', 'Não informado'), ('1', 'A+')], max_length=3, null=True),
        ),
        migrations.AlterField(
