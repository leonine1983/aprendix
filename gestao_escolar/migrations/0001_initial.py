    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_sanguineo', models.CharField(choices=[('2', 'A-'), ('1', 'A+'), ('7', 'O+'), ('0', 'Não informado'), ('3', 'B+'), ('8', 'O-'), ('5', 'AB+'), ('4', 'B-'), ('6', 'AB-')], max_length=3, null=True)),
                ...
                ('estado_civil', models.CharField(blank=True, choices=[('6', 'União Estável'), ('3', 'Separado'), ('1', 'Solteiro'), ('2', 'Casado'), ('5', 'Viúvo'), ('4', 'Divorciado')], max_length=13, null=True)),
                ('tipo_certidao', models.CharField(blank=True, choices=[('3', 'Outras'), ('1', 'Nascimento'), ('2', 'Casamento')], max_length=13, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('escolarizacao_fora', models.CharField(choices=[('2', 'Em hospital'), ('1', 'Não recebe'), ('3', 'Em domicílio')], default=1, max_length=1)),
