# Generated by Django 5.0.4 on 2024-07-30 14:42
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '1146_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('3', 'Separado'), ('6', 'União Estável'), ('5', 'Viúvo'), ('2', 'Casado'), ('4', 'Divorciado'), ('1', 'Solteiro')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('4', 'B-'), ('8', 'O-'), ('1', 'A+'), ('6', 'AB-'), ('2', 'A-'), ('5', 'AB+'), ('7', 'O+'), ('3', 'B+')], max_length=3, null=True),
        ),
        migrations.AlterField(
