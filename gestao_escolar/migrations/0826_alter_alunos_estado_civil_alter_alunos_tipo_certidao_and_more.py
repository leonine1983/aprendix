...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0825_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('8', 'O-'), ('7', 'O+'), ('0', 'Não informado'), ('6', 'AB-'), ('5', 'AB+'), ('1', 'A+'), ('4', 'B-'), ('2', 'A-'), ('3', 'B+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
