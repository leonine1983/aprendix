...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0936_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('4', 'Divorciado'), ('6', 'União Estável'), ('1', 'Solteiro'), ('3', 'Separado'), ('5', 'Viúvo'), ('2', 'Casado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('6', 'AB-'), ('3', 'B+'), ('0', 'Não informado'), ('5', 'AB+'), ('2', 'A-'), ('1', 'A+'), ('8', 'O-'), ('7', 'O+')], max_length=3, null=True),
        ),
        migrations.AlterField(
