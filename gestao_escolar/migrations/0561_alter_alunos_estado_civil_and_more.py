...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0560_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('3', 'B+'), ('5', 'AB+'), ('1', 'A+'), ('0', 'Não informado'), ('2', 'A-'), ('8', 'O-'), ('7', 'O+'), ('6', 'AB-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
