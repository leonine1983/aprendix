...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0215_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('6', 'AB-'), ('1', 'A+'), ('8', 'O-'), ('2', 'A-'), ('5', 'AB+'), ('4', 'B-'), ('0', 'Não informado'), ('7', 'O+'), ('3', 'B+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
