...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0664_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('8', 'O-'), ('7', 'O+'), ('5', 'AB+'), ('2', 'A-'), ('3', 'B+'), ('6', 'AB-'), ('1', 'A+'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
