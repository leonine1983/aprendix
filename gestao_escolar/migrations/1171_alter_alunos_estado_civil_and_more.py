...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '1170_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('3', 'B+'), ('5', 'AB+'), ('7', 'O+'), ('4', 'B-'), ('2', 'A-'), ('0', 'Não informado'), ('6', 'AB-'), ('8', 'O-')], max_length=3, null=True),
        ),
        migrations.AlterField(
