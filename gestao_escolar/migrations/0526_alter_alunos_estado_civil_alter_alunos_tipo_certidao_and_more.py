...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0525_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('4', 'Divorciado'), ('3', 'Separado'), ('2', 'Casado'), ('6', 'União Estável'), ('5', 'Viúvo'), ('1', 'Solteiro')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tipo_certidao',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('8', 'O-'), ('6', 'AB-'), ('1', 'A+'), ('5', 'AB+'), ('0', 'Não informado'), ('3', 'B+'), ('2', 'A-'), ('4', 'B-'), ('7', 'O+')], max_length=3, null=True),
        ),
        migrations.AlterField(
