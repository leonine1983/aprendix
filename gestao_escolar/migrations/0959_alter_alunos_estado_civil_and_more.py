...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0958_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('2', 'A-'), ('3', 'B+'), ('7', 'O+'), ('1', 'A+'), ('0', 'Não informado'), ('8', 'O-'), ('4', 'B-'), ('6', 'AB-'), ('5', 'AB+')], max_length=3, null=True),
        ),
        migrations.AlterField(
