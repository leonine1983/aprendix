...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0879_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('2', 'A-'), ('5', 'AB+'), ('1', 'A+'), ('7', 'O+'), ('0', 'Não informado'), ('4', 'B-'), ('8', 'O-'), ('3', 'B+'), ('6', 'AB-')], max_length=3, null=True),
        ),
        migrations.AlterField(
