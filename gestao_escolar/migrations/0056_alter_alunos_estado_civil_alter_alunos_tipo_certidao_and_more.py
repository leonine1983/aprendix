...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0055_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('2', 'Casado'), ('5', 'Viúvo'), ('3', 'Separado'), ('1', 'Solteiro'), ('6', 'União Estável'), ('4', 'Divorciado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tipo_certidao',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('2', 'A-'), ('0', 'Não informado'), ('5', 'AB+'), ('8', 'O-'), ('3', 'B+'), ('6', 'AB-'), ('7', 'O+'), ('4', 'B-'), ('1', 'A+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
