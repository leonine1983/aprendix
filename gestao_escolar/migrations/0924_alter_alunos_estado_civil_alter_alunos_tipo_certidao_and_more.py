...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0923_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('5', 'AB+'), ('3', 'B+'), ('6', 'AB-'), ('7', 'O+'), ('2', 'A-'), ('4', 'B-'), ('8', 'O-'), ('1', 'A+'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
