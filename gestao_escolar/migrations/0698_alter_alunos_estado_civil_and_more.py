...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0697_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('8', 'O-'), ('0', 'Não informado'), ('1', 'A+'), ('4', 'B-'), ('5', 'AB+'), ('6', 'AB-'), ('7', 'O+'), ('2', 'A-'), ('3', 'B+')], max_length=3, null=True),
        ),
        migrations.AlterField(
