...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '1085_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('5', 'AB+'), ('4', 'B-'), ('0', 'Não informado'), ('3', 'B+'), ('2', 'A-'), ('7', 'O+'), ('1', 'A+'), ('6', 'AB-'), ('8', 'O-')], max_length=3, null=True),
        ),
        migrations.AlterField(
