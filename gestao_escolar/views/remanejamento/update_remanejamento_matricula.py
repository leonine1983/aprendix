...
from .remanejamento_form import Turma_form


class Update_Matricula_remanejamento(LoginRequiredMixin, SuccessMessageMixin, UpdateView):
    model = Matriculas
    ...
    def get_context_data(self, **kwargs):
        ...
        context['titulo_page'] = 'Remanejamento de Turma para o aluno'          
        context['svg'] = svg 
        context['btn_bg'] = " btn-success "
        context['button'] = "Confirmar mudança de turma do aluno:"
