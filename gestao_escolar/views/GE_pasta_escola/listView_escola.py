...
class ListView_Escola(BaseSecretariosView, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Filtra escolas de acordo com o usuário
