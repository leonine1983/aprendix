...
from .views import LogoutView_logout, CreateLoginView, PainelAcessoView, MensagemCreateView, MensagemDeleteView, MensagemListView, DetalheMensagemView, UpdateMessageView   
from .views import (
    PaletaCoresListView,
